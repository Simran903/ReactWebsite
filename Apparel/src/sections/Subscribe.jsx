...
const Subscribe = () => {
  return (
    ...
    id="contact-us">
      <h3 className="text-4xl leading-[68px] lg:max-w-md font-palanquin font-bold">Sign Up for <span className="text-blue-950">Updates & Newsletter</span></h3>
      ...
      gap-5 p-2.5 sm:border sm:border-slate-gray rounded-full">
        <input type="text" placeholder="Subscribe@sneakheads.com" className="input" />
